...
namespace Parkew\Banco; // Definindo o namespace Banco
...
use Parkew\Banco\Contratos\DadosContaBancariaInterface; // Importando a interface DadosContaBancariaInterface do namespace Banco\Contratos
