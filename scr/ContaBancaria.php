...
namespace Parkew\Banco;

// Definindo o namespace Banco

use Parkew\Banco\Contratos\OperacoesContaBancariaInterface; // Importando a interface OperacoesContaBancariaInterface do namespace Banco\Contratos

use Parkew\Banco\Contratos\DadosContaBancariaInterface;

// Importando a interface DadosContaBancariaInterface do namespace Banco\Contratos
...
abstract class ContaBancaria implements DadosContaBancariaInterface, OperacoesContaBancariaInterface // Classe abstrata ContaBancaria que implementa as interfaces de operações e dados da conta
{
    ...
    public function __construct(string $banco, string $agencia, string $conta, string $tipo, string $titular, float $saldo)
    {
